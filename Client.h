...
void setPhotoPath(const QString& path) {
   ...
   QString getPhotoPath() const {
    ...
    Client(){};
    Client(int, QString, QString, QDate, QString,QString,QString,QString,QString);
...
QByteArray getIMAGE_Client() const { return IMAGE_Client; }
...
void setIMAGE_Client(const QByteArray& image) { IMAGE_Client = image; }
